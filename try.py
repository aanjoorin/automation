...
#https://github.boozallencsn.com/Anjoorin-Ademiju/automation
...
def create_github_repository(GITHUB_TOKEN, repo_name):
#    base_url = "https://github.boozallencsn.com/user/api/v3"
    base_url = "https://github.boozallencsn.com/api/v3/user/repos"
...
#Rename the dafault branch locally
#subprocess.run(["git", "branch", "-M", "main"])
...
>>>>>>> 748796774c41ff23dea6a6e7a58c660517e1588e
